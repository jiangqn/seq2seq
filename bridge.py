...
class Bridge(nn.Module):
    ...
    def forward(self, encoder_output, lstm_states):
        ...
        final_encoder_hidden, final_encoder_cell = lstm_states
        ...
        return encoder_memory, (init_decoder_hidden, init_decoder_cell)